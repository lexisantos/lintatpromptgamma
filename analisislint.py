...
path_SEAD =  "D:/Proyecto LINT at Prompt Gamma/2024-07-05_experimentAtPromptGamma/datos_05.07.24/datos_exportados_reactor.csv"
path_step = "D:/Proyecto LINT at Prompt Gamma/2024-07-05_experimentAtPromptGamma/datos_05.07.24/step_t_min_05Jul2024.txt"
path_LINT_list = glob.glob(r"D:/Proyecto LINT at Prompt Gamma/2024-07-05_experimentAtPromptGamma/datos_05.07.24/datos_contador_LINT-1/2024-07-05*.log")
path_stable = "D:/Proyecto LINT at Prompt Gamma/2024-07-05_experimentAtPromptGamma/datos_05.07.24/step_stable_05Jul2024.txt"
...
figure_SEAD = pylint.figure_SEAD(datos_sead, ['M2', 'M3'], yscale='linear')
...
pylint.fig_err(LINT_avg[:, 1], LINT_avg[:, 0], Power_list, scale= 'log')

"""Agrego(?) los errores en corriente a las incertezas por cuentas mediante incertezas efectivas:
...
path_step = "D:/Proyecto LINT at Prompt Gamma/2024-07-05_experimentAtPromptGamma/datos_05.07.24/Rampas/step_t_min_05Jul2024_conrampas.txt"
...
figure_par, totalcounts_M3, totalcurrent_M3, t_M3LINT = pylint.fig_LINT_MX_tuple(data_LINT.counts_norep, data_LINT.time_norep, current_M3_step, t_SEAD_step, power_sel = pow_sel)
figure_par.show()
...
#Los ajustes de antes me devuelven Singular matrix para bajas potencias. Eliminando ceros sigue igual (chequear)
counts_zero = totalcounts_M2[:j_cut_M2] == 0
...
ajuste_par_M2 = pylint.ajuste_pol(grado = 1, ydata = totalcounts_M2[:j_cut_M2][~counts_zero], xdata= totalcurrent_M2[:j_cut_M2][~counts_zero], y_err= pylint.np.sqrt(totalcounts_M2[:j_cut_M2][~counts_zero]))
